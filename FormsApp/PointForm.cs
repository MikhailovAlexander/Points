    ...
    public partial class PointForm : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < points.Length; i++)
                points[i] = rnd.Next(3) % 2 == 0 ? new Point(rnd.Next(10), rnd.Next(10)) : new Point3D(rnd.Next(10), rnd.Next(10), rnd.Next(10));
                ...
                new FileStream(dlg.FileName, FileMode.Create, FileAccess.Write))
            {
                switch (Path.GetExtension(dlg.FileName))
                {
                    ...
                    case ".json":
                        ...
                        /*TypeNameHandling controls whether Json.NET includes .NET type names 
                         * during serialization with a $type property and reads .NET type names 
                         * from that property to determine what type to create during deserialization
